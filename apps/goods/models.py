...
class GoodsCategory(models.Model):
    ...
    category_type = models.IntegerField(choices=category_type_choice, verbose_name='类目级别', help_text='类目级别')
...
class Goods(models.Model):
    ...
    ship_free = models.BooleanField(default=True, verbose_name='是否需要运费')
